...
export default function BlogViewCategory(props)
{
   ...
   let offset = 0; 
    let allow = true;
    async function LoadMoreBlogs(isfirst)
    {
      
       if(allow){
         allow = false;
         
      const response = await fetch("http://localhost:8080/blogs/GetBlogsCategory", {
        method: "POST",
        mode: "cors",
        headers: {
      ...
      response.json().then((data) => {
        ...
        if (data.errors != null) {
          ...
          console.log(offset);
            ...
            setMessage({
              message : isfirst ? "No Blogs" : "All Blogs Loaded",
              visible : true
         });
        }
    ...
    return (
        ...
        <div className="container-fluid ">
          <div className="row trandingcontainer2"> 
             ...
             </div>  <div className="custome2 "><span className="trandingheader">  {props.value} Blogs</span>
             </div>
